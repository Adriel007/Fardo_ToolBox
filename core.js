const core = {
    ...
    "apresent": async () => {
        ...
        normal();
        await falar("E o tema comum");
        await falar("Eu ainda não estou pronto, tenho muito chão pela frente, mas estou muito contente de que você esteja me conhecendo");
        rosto.fechar_olho(1);
        setTimeout(() => rosto.abrir_olho(1), 500);
    },
    /////////////////////////////////////////////////////////////////
